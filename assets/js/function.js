$(document).ready(function() {
    ...
    function get_map(data_map) {
        ...
        var icon_orange = L.icon({
            iconUrl: base_url + 'assets/images/marker-orange.png',
            iconSize: [38, 38],
            iconAnchor: [15, 35],
            popupAnchor: [4, -28],
            shadowUrl: base_url + 'assets/images/marker-shadow.png',
        ...
        var icon_green = L.icon({
            iconUrl: base_url + 'assets/images/marker-green.png',
            iconSize: [38, 38],
            iconAnchor: [15, 35],
            popupAnchor: [4, -28],
            shadowUrl: base_url + 'assets/images/marker-shadow.png',
        ...
        for (var i = 0; i < data_map.length; i++) {
            ...
            if (typeof data_map[i]['Coordinate'] !== "undefined" && isNaN(parseFloat(data_map[i]['Coordinate'])) === false) {
                ...
                if (data_map[i]['Rayon'] == "SE I") {
                    rayon1.push(
                        ...
                        L.marker([coordinate[0], coordinate[1]], {
                            ...
                            "<li class=\"list-group-item\">Jumlah Skidtank: " + data_map[i]['Jumlah Skidtank'] + "</li>" +
                            "<li class=\"list-group-item\">Kapasitas Skidtank: " + data_map[i]['Kapasitas Skidtank'] + "</li>" +
                             "<li class=\"list-group-item\">Jarak: " + data_map[i]['Jarak'] + "</li>" +"<li class=\"list-group-item\">Kontak SPBBE: " + data_map[i]['Kontak SPBBE'] + "</li>" +
                            "</ul>"
                ...
                } else if (data_map[i]['Rayon'] == "DEPOT") {


                    L.marker([coordinate[0], coordinate[1]]).addTo(map).bindPopup(
                        "<b>" + data_map[i]['Nama SP(P)BE'] + "</b><br>" +
                        "<ul class=\"list-group\"><li class=\"list-group-item\">Penerimaan: " + data_map[i]['Kota'] + "</li>" +
                        "<li class=\"list-group-item\">Penyaluran: " + data_map[i]['DOT(MT)'] + "</li>" +
                        "<li class=\"list-group-item\">Pumple Stock: " + data_map[i]['Stock'] + "</li>" +

                        "<li class=\"list-group-item\">Next Supply: " + data_map[i]['Kapasitas Tanki Timbun (MT)'] + "</li>" +

                        "<li class=\"list-group-item\">PIC: " + data_map[i]['Jarak'] + "</li>" +
                        "</ul>"
                    )
                }
